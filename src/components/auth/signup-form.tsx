  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <form onSubmit={handleSignup} className="w-full space-y-4">
        ...
        <Button type="submit" className="w-full h-12 bg-zinc-950 dark:bg-white hover:bg-zinc-800 dark:hover:bg-zinc-200 text-white dark:text-black font-semibold text-base mt-6 transition-colors animate-in fade-in duration-300" disabled={isLoading}>
          {isLoading ? "Creating account..." : "Sign Up"}
        </Button>

        <div className="text-center text-sm text-zinc-500 dark:text-zinc-400 mt-8 pt-4">
          Already have an account?{" "}
          <Link href="/auth/login" className="text-zinc-950 dark:text-white font-semibold hover:underline">
            Sign In
          </Link>
        </div>
      </form>
