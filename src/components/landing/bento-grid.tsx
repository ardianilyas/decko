    ...
    <section id="features" className="relative z-10 py-24 border-t border-black/5 dark:border-white/5 bg-zinc-50/20 dark:bg-[#050507]/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-auto">
          ...
          {/* Feature 2 */}
          <div className="glass-card-premium rounded-3xl p-6 flex flex-col justify-between relative overflow-hidden border-zinc-200/50 dark:border-white/5 hover:border-indigo-500/30 dark:hover:border-indigo-500/30 hover:bg-white/75 dark:hover:bg-[#121217]/75 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 group text-left">
            <div className="absolute inset-0 bg-indigo-500/[0.005] dark:bg-[radial-gradient(circle_at_center,_rgba(99,102,241,0.05)_0%,_transparent_60%)] pointer-events-none" />
            <div className="relative z-10">
            ...
            <div className="relative z-10 bg-zinc-100/40 dark:bg-black/20 border border-black/[0.06] dark:border-white/5 rounded-xl p-2.5 mt-4 flex flex-col gap-1.5 text-xs text-zinc-600 dark:text-zinc-400 backdrop-blur-sm">
              <div className="flex justify-between items-center bg-indigo-500/5 dark:bg-indigo-400/5 border border-indigo-500/10 dark:border-indigo-400/10 p-1.5 rounded-lg">
                <span className="font-semibold text-indigo-700 dark:text-indigo-300">Owl Alpha</span>
          ...
          <div className="glass-card-premium rounded-3xl p-6 flex flex-col justify-between relative overflow-hidden border-zinc-200/50 dark:border-white/5 hover:border-indigo-500/30 dark:hover:border-indigo-500/30 hover:bg-white/75 dark:hover:bg-[#121217]/75 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 group text-left">
            ...
            <div className="relative z-10 bg-zinc-100/40 dark:bg-black/20 border border-black/[0.06] dark:border-white/5 rounded-xl p-2.5 mt-4 space-y-2 text-[11px] backdrop-blur-sm">
              ...
              <div className="bg-indigo-500/5 dark:bg-indigo-500/10 border border-indigo-500/10 rounded-lg p-1.5 max-w-[90%] ml-auto text-left flex items-start gap-1">
          ...
          <div className="glass-card-premium rounded-3xl p-6 flex flex-col justify-between relative overflow-hidden border-zinc-200/50 dark:border-white/5 hover:border-indigo-500/30 dark:hover:border-indigo-500/30 hover:bg-white/75 dark:hover:bg-[#121217]/75 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 group text-left">
            ...
            <div className="relative z-10 bg-zinc-100/40 dark:bg-black/20 border border-black/[0.06] dark:border-white/5 rounded-xl p-2.5 mt-4 flex gap-2 justify-center backdrop-blur-sm">
              <div className="flex-1 flex items-center justify-center gap-1 p-1.5 rounded-lg bg-indigo-500/5 dark:bg-indigo-500/10 border border-indigo-500/10 text-indigo-650 dark:text-indigo-400 font-semibold text-[10px]">
          ...
          <div className="glass-card-premium rounded-3xl p-6 flex flex-col justify-between relative overflow-hidden border-zinc-200/50 dark:border-white/5 hover:border-indigo-500/30 dark:hover:border-indigo-500/30 hover:bg-white/75 dark:hover:bg-[#121217]/75 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 group text-left">
            ...
            <div className="relative z-10 bg-zinc-100/40 dark:bg-black/20 border border-black/[0.06] dark:border-white/5 rounded-xl p-4 mt-4 space-y-3 shrink-0 backdrop-blur-sm">
              <div className="flex items-center gap-2 border-b border-black/[0.06] dark:border-white/5 pb-2">
                <div className="w-3.5 h-3.5 rounded bg-indigo-500/20 shrink-0" />
                <div className="h-2.5 bg-indigo-500/20 rounded w-16" />
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-indigo-500/10 dark:bg-indigo-500/20 shrink-0 animate-pulse" />
                  <div className="h-2 bg-indigo-500/10 dark:bg-indigo-500/20 rounded w-[60%] animate-pulse" />
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-indigo-500/10 dark:bg-indigo-500/20 shrink-0 animate-pulse" />
                  <div className="h-2 bg-indigo-500/10 dark:bg-indigo-500/20 rounded w-[50%] animate-pulse" />
                </div>
              </div>
            </div>
          </div>
