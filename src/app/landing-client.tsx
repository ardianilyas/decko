  ...
  return (
    <div className="min-h-screen bg-[#fafcf7] dark:bg-[#030303] text-zinc-800 dark:text-zinc-100 font-sans selection:bg-amber-400 selection:text-black overflow-x-clip relative transition-colors duration-300">
      ...
      <div className="sticky top-0 z-50 w-full px-4 sm:px-6 lg:px-8 pointer-events-none pt-4">
        <header className="max-w-5xl mx-auto h-14 rounded-full border border-black/8 dark:border-white/12 bg-white/65 dark:bg-[#0c0c0f]/65 backdrop-blur-xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] dark:shadow-black/40 flex items-center justify-between px-6 pointer-events-auto">
          {/* Logo */}
      ...
      <section id="features" className="relative z-10 py-24 border-t border-black/5 dark:border-white/5 bg-zinc-50/20 dark:bg-[#050507]/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-auto">
            ...
            <div className="glass-card-premium rounded-3xl p-8 md:col-span-2 md:row-span-2 flex flex-col justify-between relative overflow-hidden border-indigo-500/15 dark:border-indigo-500/25 hover:border-indigo-500/40 hover:shadow-indigo-500/5 group text-left min-h-[380px] md:min-h-[460px]">
              <div className="absolute inset-0 bg-indigo-500/[0.015] dark:bg-[radial-gradient(circle_at_center,_rgba(99,102,241,0.07)_0%,_transparent_60%)] pointer-events-none" />
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center mb-6 text-indigo-500 dark:text-indigo-400 animate-pulse">
                  <Zap className="w-6 h-6" />
                </div>
                <h3 className="text-2xl font-semibold text-zinc-900 dark:text-white mb-3">Instant AI Generation</h3>
                <p className="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed max-w-xl mb-6">
              ...
              <div className="relative z-10 bg-zinc-50/50 dark:bg-black/40 border border-black/5 dark:border-white/5 rounded-xl p-4 mt-auto">
                <div className="flex items-center justify-between mb-3 border-b border-black/5 dark:border-white/5 pb-2">
                  <span className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">AI Steps Checklist</span>
            ...
            <div className="glass-card-premium rounded-3xl p-8 flex flex-col justify-between relative overflow-hidden border-amber-500/15 dark:border-amber-500/25 hover:border-amber-500/40 hover:shadow-amber-500/5 group text-left min-h-[220px]">
              <div className="absolute inset-0 bg-amber-500/[0.015] dark:bg-[radial-gradient(circle_at_center,_rgba(245,158,11,0.07)_0%,_transparent_60%)] pointer-events-none" />
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-amber-400/10 border border-amber-400/20 flex items-center justify-center mb-6 text-amber-600 dark:text-amber-300">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-2">DeepSeek & GPT-4o</h3>
            ...
            <div className="glass-card-premium rounded-3xl p-8 flex flex-col justify-between relative overflow-hidden border-rose-500/15 dark:border-rose-500/25 hover:border-rose-500/40 hover:shadow-rose-500/5 group text-left min-h-[220px]">
              <div className="absolute inset-0 bg-rose-500/[0.015] dark:bg-[radial-gradient(circle_at_center,_rgba(244,63,94,0.07)_0%,_transparent_60%)] pointer-events-none" />
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-rose-500/10 border border-rose-500/20 flex items-center justify-center mb-6 text-rose-500 dark:text-rose-400">
                  <History className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-2">Free Chat Revisions</h3>
                <p className="text-zinc-600 dark:text-zinc-400 text-xs sm:text-sm leading-relaxed">
            ...
            <div className="glass-card-premium rounded-3xl p-8 flex flex-col justify-between relative overflow-hidden border-emerald-500/15 dark:border-emerald-500/25 hover:border-emerald-500/40 hover:shadow-emerald-500/5 group text-left min-h-[220px]">
              <div className="absolute inset-0 bg-emerald-500/[0.015] dark:bg-[radial-gradient(circle_at_center,_rgba(16,185,129,0.07)_0%,_transparent_60%)] pointer-events-none" />
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mb-6 text-emerald-500 dark:text-emerald-400">
                  <FileText className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-2">Document Exports</h3>
                <p className="text-zinc-600 dark:text-zinc-400 text-xs sm:text-sm leading-relaxed">
            ...
            <div className="glass-card-premium rounded-3xl p-8 md:col-span-2 flex flex-col md:flex-row gap-6 items-center justify-between relative overflow-hidden border-purple-500/15 dark:border-purple-500/25 hover:border-purple-500/40 hover:shadow-purple-500/5 group text-left min-h-[220px]">
              <div className="absolute inset-0 bg-purple-500/[0.015] dark:bg-[radial-gradient(circle_at_center,_rgba(139,92,246,0.07)_0%,_transparent_60%)] pointer-events-none" />
              <div className="relative z-10 flex-1">
                <div className="w-12 h-12 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center mb-6 text-purple-500 dark:text-purple-400 animate-pulse">
                  <Activity className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-2">Visual Skeletons & stable UI</h3>
              ...
              <div className="relative z-10 bg-zinc-50/50 dark:bg-black/40 border border-black/5 dark:border-white/5 rounded-xl p-4 w-full md:w-[220px] space-y-3 shrink-0">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-purple-500/10 dark:bg-purple-500/20 shrink-0" />
                    <div className="h-2 bg-purple-500/10 dark:bg-purple-500/20 rounded w-[60%]" />
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-purple-500/10 dark:bg-purple-500/20 shrink-0" />
                    <div className="h-2 bg-purple-500/10 dark:bg-purple-500/20 rounded w-[50%]" />
                  </div>
                </div>
              </div>
            </div>
            ...
            {PRICING_PLANS.map((plan, index) => (
              <div
                ...
                className={`glass-card-premium rounded-2xl p-8 flex flex-col justify-between text-left relative ${
                  plan.popular ? "border-amber-500/30 dark:border-amber-400/40 ring-1 ring-amber-500/20 dark:ring-amber-400/20 bg-white dark:bg-[#0c0c0e]/85 shadow-md shadow-zinc-900/5 dark:shadow-none" : ""
                }`}
              >
                {plan.popular && (
                ...
                <div>
                  ...
                  <div className="border-t border-black/5 dark:border-white/5 pt-6 mb-8 space-y-3.5">
                ...
                <Link
                  ...
                  className={`w-full text-center py-3.5 rounded-xl font-semibold text-sm transition-all ${
                    plan.popular
                      ...
                      : "bg-zinc-100 dark:bg-white/5 hover:bg-zinc-200 dark:hover:bg-white/10 text-zinc-900 dark:text-white border border-black/5 dark:border-white/10 hover:border-black/10 dark:hover:border-white/20"
                  }`}
                >
                  {plan.buttonText}
                </Link>
          ...
          <div className="space-y-4">
            {FAQS.map((faq, index) => {
              ...
              return (
                <div
                  key={index}
                  className="glass-card-premium rounded-xl border border-black/5 dark:border-white/5 overflow-hidden transition-all duration-300"
                >
                  <button
                    onClick={() => setActiveFaq(isOpen ? null : index)}
                    className="w-full flex items-center justify-between p-6 text-left focus:outline-none cursor-pointer"
                  >
                    <span className="font-semibold text-zinc-900 dark:text-white text-sm sm:text-base pr-4">
                      {faq.question}
                    </span>
                    <ChevronDown
                      className={`w-4 h-4 text-zinc-500 dark:text-zinc-400 transition-transform duration-300 shrink-0 ${
                  ...
                  <div
                    className={`transition-all duration-300 ease-in-out ${
                      isOpen
                        ? "max-h-[300px] border-t border-black/5 dark:border-white/5"
                        : "max-h-0 pointer-events-none"
                    }`}
                  >
                    <p className="p-6 text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed">{faq.answer}</p>
                  </div>
                </div>
              );
            })}
